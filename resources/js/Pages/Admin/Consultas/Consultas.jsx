...
const Consultas = ({ consultas, pacientes, dias_semana }) => {
    /**
                    ...
                    <Row className="g-3">
                        ...
                        <Col xs={12} lg={6}>
                            <FormSelect
                                ...
                                required={true}
                                isInvalid={
                                    validatedCadastro && errorsCadastro.data
                                }
                                onChange={(e) =>
                                    setDataCadastro("data", e.target.value)
                                }
                                textError={
                                    errorsCadastro.data ?? "Informe a data"
                                }
                            />
                        </Col>
                        ...
                        <Col xs={12} lg={6}>
                            <FormSelect
                                ...
                                required={true}
                                isInvalid={
                                    validatedCadastro && errorsCadastro.hora
                                }
                                onChange={(e) =>
                                    setDataCadastro("hora", e.target.value)
                                }
                                textError={
                                    errorsCadastro.hora ?? "Informe a hora"
                                }
                            />
                        </Col>
                    </Row>
